...
if (script === undefined) {
  ...
  script = document.querySelector('script[src^="https://hanabiiii.github.io/mason-dev-comments/client.js"],script[src^="http://localhost:4000/client.js"]') as HTMLScriptElement;
}
...
const utterancesOrigin = script.src.match(/^https:\/\/mason-dev\.cf|https:\/\/hanabiiii\.github.io\/mason-dev-comments|http:\/\/localhost:\d+/)![0];
